...
public class PredixBootSecurityConfig extends WebSecurityConfigurerAdapter
{
            ...
            throws Exception
    {
        ...
        http.headers().addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Headers", "X-PINGOTHER, Origin, X-Requested-With, Content-Type, Accept"));
        http.headers().addHeaderWriter(new StaticHeadersWriter("Access-Control-Max-Age", "1728000"));
